                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="" class="nav-item nav-link">Annonces</a>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                <div class="product-item bg-light mb-4">
                    <div class="product-img position-relative overflow-hidden">
                        <img class="img-fluid w-100" src="{{ $annonce->cover }}" alt="{{ $annonce->title }}">
                        <div class="product-action">
                            <!-- Ajoutez vos actions pour l'annonce ici -->
                        </div>
                    </div>
                    <div class="text-center py-4">
                        ...
                        <div class="d-flex align-items-center justify-content-center mb-1">
                            <!-- Ajoutez ici d'autres informations de l'annonce telles que la note, le nombre de commentaires, etc. -->
                        </div>
                    </div>
                </div>
            </div>
