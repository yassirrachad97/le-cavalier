...
<div class="row px-xl-5">
    ...
    <div class="col-lg-3 col-md-4 col-sm-6 pb-1">
        <div class="product-item bg-light mb-4 shadow">
            ...
            <div class="d-flex gap-2 justify-content-between">
                ...
                <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#updateModal{{ $annonce->id }}">update</button>
    ...
    <div class="modal fade" id="updateModal{{ $annonce->id }}" tabindex="-1" role="dialog" aria-labelledby="updateModalLabel{{ $annonce->id }}" aria-hidden="true">
                ...
                <form action="{{ route('annonces.update', ['annonce' => $annonce->id]) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="phone_appel" name="phone_appel" value="{{ $annonce->phone_appel }}" required>
                        </div>
                        <div class="form-group">
                            <label for="phone_wathsapp">Téléphone (WhatsApp)</label>
                            <input type="text" class="form-control" id="phone_wathsapp" name="phone_wathsapp" value="{{ $annonce->phone_wathsapp }}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="city_id" name="city_id" required>
                                ...
                                <option value="{{ $city->id }}" {{ $annonce->city_id == $city->id ? 'selected' : '' }}>{{ $city->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div id="horseFields" style="{{ $annonce->horse_id ? 'display: block;' : 'display: none;' }}">
                            <div class="form-group">
                                <label for="horse_name">Nom du cheval</label>
                                <input type="text" class="form-control" id="horse_name" name="horse_name" value="{{ $annonce->horse_id ? $annonce->horse->horse_name : '' }}">
                            </div>
                            <div class="form-group">
                                <label for="horse_age">Âge du cheval</label>
                                <input type="number" class="form-control" id="horse_age" name="horse_age" value="{{ $annonce->horse_id ? $annonce->horse->horse_age : '' }}">
                            </div>
                            <div class="form-group">
                                <label for="horse_color">Couleur du cheval</label>
                                <input type="text" class="form-control" id="horse_color" name="horse_color" value="{{ $annonce->horse_id ? $annonce->horse->horse_color : '' }}">
                            </div>
                            <div class="form-group">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="horse_pedigree" name="horse_pedigree" {{ $annonce->horse_id && $annonce->horse->horse_pedigree ? 'checked' : '' }}>
                        ...
                        <div id="accessoireFields" style="{{ $annonce->accessoire_id ? 'display: block;' : 'display: none;' }}">
                            <div class="form-group">
                                <label for="accessoire_type">Type d'accessoire</label>
                                <input type="text" class="form-control" id="accessoire_type" name="accessoire_type" value="{{ $annonce->accessoire_id ? $annonce->accessoire->accessoire_type : '' }}">
                            </div>
                            <div class="form-group">
                                <label for="accessoire_name">Nom de l'accessoire</label>
                                <input type="text" class="form-control" id="accessoire_name" name="accessoire_name" value="{{ $annonce->accessoire_id ? $annonce->accessoire->accessoire_name : '' }}">
                            </div>
                        </div>
                    </div>
